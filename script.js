...
apiKey: "AIzaSyAd6BBK1TrmjMLUnSBra1jNjHRytbjrMzE",
authDomain: "battleguesser.firebaseapp.com",
projectId: "battleguesser",
storageBucket: "battleguesser.firebasestorage.app",
messagingSenderId: "428809142926",
appId: "1:428809142926:web:cd90651d5e6dfbfe88ffdf",
measurementId: "G-5GTJXERN8B"
};

// Firebase collection name
const leaderboardCollection = "battleleaderboard";

// Firebase instances - we'll initialize these after loading Firebase scripts
let db;

// Function to initialize Firebase - call this from your document ready handler
...
async function submitScore() {
    ...
    try {
        ...
        const data = {
            ...
            timestamp: firebase.firestore.FieldValue.serverTimestamp() // For proper sorting
        };

        console.log(data);
        
        // Send data to Firebase
        await db.collection(leaderboardCollection).add(data);
...
async function fetchLeaderboard() {
    try {
        ...
        // Fetch data from Firebase, sorted by score in descending order
        const snapshot = await db.collection(leaderboardCollection)
            .orderBy('score', 'desc')
            .limit(10)
            .get();
